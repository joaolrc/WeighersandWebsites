/*ESP code
  Até 3 leituras diferentes separadas por espaços e a acabar com line feed "\n" */

#include <SoftwareSerial.h>
#include <ESP8266WiFi.h>

#define debug 1;                      //comentar para não haver comunicação série pela porta mini-USB
...
String url = "/mcm/insertonce.php"; //cria uma nova linha na tabela de pesos. Efetua 1 vez ao ligar a máquina (setup)
